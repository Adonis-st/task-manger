...
export const BoardsDropdown = ({
  ...
  const { data: getAllBoards } = trpc.boards.getAllBoards.useQuery();
        ...
        <div className="fixed top-0 left-0 hidden h-full w-[260px] overflow-x-hidden border-r border-lines_light bg-white py-5 dark:border-lines dark:bg-dark_gray sm:block xl:w-[300px]">
          <div className="flex flex-col gap-y-4 pr-8">
            ...
            <button
              ...
              className="flex items-center fill-purple py-1 text-purple hover:fill-purple_hover hover:text-purple_hover dark:hover:fill-white dark:hover:text-white"
            >
              ...
              <h4 className="heading-m ml-4">+ Create New Board</h4>
            </button>
          </div>
...
pointer-events-none inline-block h-[17px] w-[17px] transform self-center rounded-full bg-white shadow-lg transition duration-200 ease-in-out`}
            ...
            >
              ...
              <span className="heading-m ml-2">Hide Sidebar</span>
            </button>
          </div>
        </div>
      )}
      ...
      >
        <h1 className="heading-l min-w-[120px] max-w-fit dark:text-white">
          {singleBoard?.title ?? " Create a new Board"}
        </h1>
      </div>
      ...
      <div className="relative sm:hidden">
        <>
          <button
            ...
            className={`
                ${displayMobileMenu ? "" : "text-opacity-90"}
          ...
          >
            ...
            <ChevronDownIcon
              className={`${
                displayMobileMenu ? "rotate-180 transform" : "text-opacity-70"
              }
                  ml-1 h-5 w-5 text-purple transition duration-150 ease-in-out group-hover:text-opacity-80`}
            />
          </button>

          <Transition appear show={displayMobileMenu} as={Fragment}>
            <Dialog
              as="div"
            ...
            >
              ...
              <div className="fixed inset-0 overflow-y-auto">
                <div className="mt-14 flex  justify-center p-4 text-center">
                  <Transition.Child
                    as={Fragment}
                    enter="ease-out duration-300"
                  ...
                  >
                    <Dialog.Panel className="w-[78%] max-w-sm overflow-hidden rounded-lg   text-left shadow-xl transition-all">
                      <div className="relative flex flex-col gap-y-4 bg-white py-5 pr-8 dark:bg-dark_gray">
                        <ProjectData
                          singleBoard={singleBoard}
                          getAllBoards={getAllBoards}
                        />
                        ...
                        <button
                          onClick={() => setDisplayModal(true)}
                          className=" flex items-center fill-purple text-purple hover:fill-purple_hover hover:text-purple_hover dark:hover:fill-white dark:hover:text-white"
                        >
